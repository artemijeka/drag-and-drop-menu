 ...
 * @polyfill (closest): https://cdn.polyfill.io/v1/polyfill.js?features=Element.prototype.closest
 * @var draggableSelector (string)
 **/
function DragManager(draggableSelector) {
  /**
